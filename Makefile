#############################################################################
# Makefile for building: testqml
# Generated by qmake (3.0) (Qt 5.1.1) on: ven. oct. 25 17:34:33 2013
# Project:  testqml.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile testqml.pro
#############################################################################
...
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I. -Iqtquick2applicationviewer -I/usr/include/qt -I/usr/include/qt/QtQuick -I/usr/include/qt/QtQml -I/usr/include/qt/QtNetwork -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1,--sort-common,--as-needed,-z,relro -Wl,-O1 -Wl,-rpath-link,/usr/lib
LIBS          = $(SUBLIBS) -lQt5Quick -lQt5Qml -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: testqml.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/testqml1.0.0 || mkdir -p .tmp/testqml1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/testqml1.0.0/ && $(COPY_FILE) --parents qtquick2applicationviewer/qtquick2applicationviewer.h .tmp/testqml1.0.0/ && $(COPY_FILE) --parents main.cpp qtquick2applicationviewer/qtquick2applicationviewer.cpp .tmp/testqml1.0.0/ && (cd `dirname .tmp/testqml1.0.0` && $(TAR) testqml1.0.0.tar testqml1.0.0 && $(COMPRESS) testqml1.0.0.tar) && $(MOVE) `dirname .tmp/testqml1.0.0`/testqml1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/testqml1.0.0
...
moc_qtquick2applicationviewer.cpp: /usr/include/qt/QtQuick/QQuickView \
...
main.o: main.cpp /usr/include/qt/QtGui/QGuiApplication \
...
install_itemfolder_01: first FORCE
	@test -d $(INSTALL_ROOT)/opt/testqml/qml || mkdir -p $(INSTALL_ROOT)/opt/testqml/qml
	-$(INSTALL_DIR) /home/raoul/tmp/qml-tryout/qml/testqml $(INSTALL_ROOT)/opt/testqml/qml/

uninstall_itemfolder_01: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/testqml/qml/testqml
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/testqml/qml/ 


install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/testqml/bin || mkdir -p $(INSTALL_ROOT)/opt/testqml/bin
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/testqml/bin/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/opt/testqml/bin/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/testqml/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/testqml/bin/ 
